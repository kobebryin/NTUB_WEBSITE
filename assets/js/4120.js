...
// @codekit-prepend "plugins/swipe.js"
// @codekit-prepend "plugins/jquery.fitvids.js"
// @codekit-prepend "plugins/jquery.fittext.js"
// @codekit-prepend "plugins/jquery.flickr.js"
// @codekit-prepend "plugins/bind.js"
// @codekit-append "portfolio.js"
...
;(function($, Swipe) {
  ...
  $(document).ready(function() {
    $('.swiper').each(function() {
      var $el = $(this);
      var el = $el.get(0);
      var swiper = new Swipe(el);

      // setInterval(function() {
      //   swiper.next();
      // }, 5000);

      $arrows = $el.closest('.container').find('.arrows');
    ...
    $(".fittext").each(function() {
      $el = $(this);
      $el.fitText(1.2, {
        maxFontSize: $el.attr('data-max-font-size'),
        minFontSize: $el.attr('data-min-font-size')
      });
    });
    ...
    $('.flickr').each(function() {
      $el = $(this);
      $el.flickr({
        user_name: $el.attr('data-flickr-username'),
        view_num: $el.attr('data-flickr-count'),
        size: $el.attr('data-flickr-size')
      });
    });
...
;(function($) {
  ...
  $.extend(Portfolio.prototype, {
    setup: function() {
      $('.category-filter li a', this.$el)
        .click(this.onFilterClick.bind(this));
    },
    ...
    onFilterClick: function(e) {
      ...
      $('.category-filter a.active').removeClass('active');
    ...
    filter: function(filter) {
      ...
      $('.project[data-category~="' + filter + '"]', $projects).addClass('active');
    },

    reset: function() {
      $('.category-filter a.active', this.$el).removeClass('active');
      $('.projects', this.$el).removeClass('filtered');
      $('.projects .project', this.$el).removeClass('active');
    }
  });
